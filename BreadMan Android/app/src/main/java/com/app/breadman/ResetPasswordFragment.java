...
public class ResetPasswordFragment extends Fragment implements View.OnClickListener {
    ...
    private EditText et_otp, et_new_password, et_confirm_password;
    ...
    private String strOtp, strNewPassword, strDeviceToken;
        ...
        if (view == btn_reset) {
            ...
            if (et_otp.getText().toString().trim().length() == 0) {
                ...
                Snackbar snackbar = Snackbar
                        .make(btn_reset, "Enter otp", Snackbar.LENGTH_LONG)
                ...
                if (et_new_password.getText().toString().trim().length() == 0) {
                    ...
                    Snackbar snackbar = Snackbar
                            .make(btn_reset, "Enter password", Snackbar.LENGTH_LONG)
                    ...
                    Snackbar snackbar = Snackbar
                            .make(btn_reset, "Password mismatched", Snackbar.LENGTH_LONG)
                    ...
                    if (Constant.isConnected(getActivity()) == false) {
                        Snackbar snackbar1 = Snackbar
                                .make(btn_reset, "No Internet Connection Found", Snackbar.LENGTH_LONG)
                ...
                Snackbar snackbar = Snackbar
                        .make(btn_reset, "Enter Valid Otp", Snackbar.LENGTH_LONG)
                        .setAction("OTP", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                            }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.URL_RESET_PASSWORD,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Snackbar.make(btn_reset, e.toString(), Snackbar.LENGTH_LONG).show();
                        }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Snackbar.make(btn_reset, error.toString(), Snackbar.LENGTH_LONG).show();
                    }
                }) {
...
//                map.put(Constant.KEY_CONTENT_TYPE, "application/x-www-form-urlencoded");
            ...
            public Map<String, String> getParams() {
                ...
                map1.put(Constant.KEY_EMAIL, ForgotPasswordFragment.strEmail);
